...
import { MediaFields } from '@/components/project/media/MediaFields';
...
export function AddCodeProjectForm({ options }: { options?: DisciplineOptions }) {
  ...
  return (
    <form action={handleSubmit} className="grid gap-3 md:grid-cols-2">
      ...
      <SubmitButton className="md:col-span-2 justify-self-start w-auto min-w-[200px] rounded-md px-5 py-3 tracking-[0.22em] shadow-[0_0_24px_rgba(223,255,0,0.14)] hover:shadow-[0_0_34px_rgba(223,255,0,0.22)]">
        ADD CODE PROJECT
      </SubmitButton>
      {state?.success && (
