...
import { IDEHeader } from '@/components/project/detail/IdeHeader';
import { JSDocOverview } from '@/components/project/detail/JsdocOverview';
import { CodeAccordion } from '@/components/project/detail/CodeAccordion';
import { TechSpecsGrid } from '@/components/project/detail/TechSpecsGrid';
import { ParallaxGallery } from '@/components/project/detail/ParallaxGallery';
import { TerminalBackButton } from '@/components/project/detail/TerminalBackButton';
import {
  DISCIPLINE_LABELS,
...
export function ProjectDetailClient({ project }: ProjectDetailClientProps) {
  ...
  if (isCode) {
    const techSpecs = [
      ...
      { key: "TOOLS", value: project.tools || 'N/A' },
    ];
